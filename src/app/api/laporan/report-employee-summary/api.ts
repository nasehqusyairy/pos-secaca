...
export function getReportEmployeeSummary(params: ReportEmployeeSummaryRequest) {
    const param = {
        ...params,
    ...
    return apiClientV2.get(`/api/backoffice/report/report_employee_summary`, { params: param })
}