...
const TransferProduct_COLUMNS = ["Produk", "Unit", "Kuantitas"];

interface FieldTransferProductProps {
    form: any;
    products: Product[];
    productUnits: ProductUnits[];
    data: TransferProduct | null;
    isApproved: boolean;
}
...
const FieldTransferProduct: FC<FieldTransferProductProps> = ({
    ...
    useEffect(() => {
		...
		if (val && val.length > 0) {
            ...
            setValueTransferProducts(data?.product_transfer_service_details, form);
        }
    ...
    return ( 
        <div>
            ...
            <Button variant="secondary" className="ml-auto mt-4" onClick={() => onAdd()} type="button" disabled={isApproved}>
            ...
            <Table className="border rounded-xl mt-4">
                ...
                <TableBody>
                                ...
                                <TableCell>
                                    <FormItem>
                                        <Select value={productUnitValue} onValueChange={handleSelectProductUnit}>
                                            ...
                                            <SelectGroup>
                                                {
                                                    productUnits && productUnits?.map((item: ProductUnits, i: number) => (
                    ...
                    {values && values.map((item: ProductTransferDetail, i: number) => {
                        ...
                        return (
                            ...
                            <TableCell  className={cn("w-[100px]")}>
                                <Button size="icon" variant="outline" onClick={() => handleDelete(i)} disabled={isApproved} type="button">
