...
import { ReportSalesColumns } from "./column";
...
import { useGetReportSalesQuery } from "@/app/api/laporan/report-sales/queries";
import { ReportSalesTable } from "./table";
...
const LaporanPenjualanPage: FC<LaporanPenjualanPageProps> = () => {
    ...
    const { data, isFetching, refetch } = useGetReportSalesQuery({ start_at, end_at, locs, exclude_locs, select_all_location, limit, page, keyword, discounted });
    ...
    const columns = ReportSalesColumns()
    return (
        <>
            <div>
                <PageTitleSetting title={t("report_sales")} />
            </div>
            ...
            <div className="container mx-auto">
                ...
                {
                    isFetching ? <SkeletonSimple /> : <ReportSalesTable columns={columns} data={data?.data.data} />
                }
