...
import { ReportEmployeeDetailColumns } from "./column";
...
import { ReportEmployeeDetailTable } from "./table";
import { useGetReportEmployeeDetailQuery } from "@/app/api/laporan/report-employee-detail/queries";
...
const LaporanStockCardPage: FC<LaporanStockCardPageProps> = () => {
    ...
    const { data, isFetching, refetch } = useGetReportEmployeeDetailQuery({ 
    ...
    const columns = ReportEmployeeDetailColumns()
    return (
        <>
            <div>
                <PageTitleSetting title={t("laporanEmployeeDetail")} />
            </div>
            ...
            <div className="container mx-auto">
                ...
                {
                    isFetching ? <SkeletonSimple /> : <ReportEmployeeDetailTable columns={columns} data={data?.data.data} />
                }
