...
import { ReportEmployeeDetail } from "@/app/api/laporan/report-employee-detail/type";

export const ReportEmployeeDetailColumnShow = {
    employee_sales_name: true,
    location_name: true,
    local_sales_date: true,
    sales_amount: true,
    refund_amount: true,
...
export const ReportEmployeeDetailColumns = (): ColumnDef<ReportEmployeeDetail>[] => {
